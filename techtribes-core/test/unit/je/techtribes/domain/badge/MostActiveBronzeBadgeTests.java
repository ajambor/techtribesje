...
public class MostActiveBronzeBadgeTests extends ActivityBadgeTestsSupport {

    @Override
    protected ActivityBadge createBadge() {
        return new MostActiveBronzeBadge();
    }
    ...
    public void test_findEligibleContentSources_ReturnsAListOfOneContentSource_WhenPassedAnActivityList() {
        ...
        assertTrue(badge.findEligibleContentSources(activityList).contains(person3));
    }
