...
public class CommunityMentionerBadgeTests extends BadgeTestsSupport {

    @Test
    public void test_findEligibleContentSources_ReturnsAnEmptyList_WhenThereAreNoTweets() {
        CommunityMentionerBadge badge = new CommunityMentionerBadge();
    ...
    @Test
    public void test_findEligibleContentSources_ReturnsAllContentSources_WhenThereAreTweetsButNoCommunityMentions() {
        CommunityMentionerBadge badge = new CommunityMentionerBadge();
        Collection<Tweet> tweets = new LinkedList<>();
