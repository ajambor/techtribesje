...
public abstract class AbstractHowlerBadge extends AbstractBadge implements TalkBadge {

    protected AbstractHowlerBadge(int id, String name, String description) {
